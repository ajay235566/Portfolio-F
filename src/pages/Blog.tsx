...
const Blog = () => {
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-brand-blue/10 blur-[120px] rounded-full" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-brand-red/10 blur-[120px] rounded-full" />
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl glass border-white/10 hover:bg-white/5 transition-all font-bold text-lg"
        >
